...
public class WebIATWS extends WebSocketListener {
	...
	private static final String appid = "6b051272"; //在控制台-我的应用获取
	private static final String apiSecret = "YWE3MWM4NGExOTk4YjZjNjVhMWNlOTVi"; //在控制台-我的应用-语音听写（流式版）获取
	private static final String apiKey = "531ff9d911c69221d3bd7dfe892eefe1"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String file = "E:\\code\\java_sqlserver\\record\\test.pcm"; // 中文
        ...
        if (resp != null) {
            ...
            if (resp.getData() != null) {
                ...
                if (resp.getData().getStatus() == 2) {
                    ...
                    System.out.println("字符串处理后："+tonum.getStr(decoder.toString()));
                    decoder.discard();
