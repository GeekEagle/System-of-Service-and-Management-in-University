...
public class Jstudenthonor extends JFrame{
    public Jstudenthonor() {
        this.setSize(1000,800);
        this.setTitle("学生荣誉信息");
        ...
        btnOK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String SQL = "select * from 获奖记录表_view where StuID="+txtSno.getText();
                    stmt = con.createStatement();
                    rs =stmt.executeQuery(SQL);
                    if(rs.next())
                    {
                        Jstudenthonorupdata f = new Jstudenthonorupdata(txtSno.getText());
                        f.setVisible(true);
                    }
                    else
                    {
                        JOptionPane.showMessageDialog(frame, "该学生无荣誉获得记录，可插入荣誉获得记录");
                        Jstudenthonorupdata f = new Jstudenthonorupdata(txtSno.getText());
                        f.setVisible(true);
                    }
                }
