...
public class JstudentteacherselectFrame extends JFrame{
	    public JstudentteacherselectFrame() {
	        ...
	        btnOK.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                try {
	    	            ...
	    	            if(rs.next())
	    	            {
	    	            	JstudentteacherupdateFrame f = new JstudentteacherupdateFrame(txtSno.getText());
		    		        f.setVisible(true);
	    	            }
	    	            else
	    	            {
		                    JOptionPane.showMessageDialog(frame, "该学号学生无记录");
		                    JstudentteacherupdateFrame f = new JstudentteacherupdateFrame(txtSno.getText());
		    		        f.setVisible(true);
	    	            }
	                }    	 
	        ...
	        JButton btnALL=new JButton("查看全部信息");
	        pane.add(btnALL);
	        btnALL.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                try {
	    	            ...
	    	            if(rs.next())
	    	            {
	    	            	JstudentteacherupdateFrame f = new JstudentteacherupdateFrame();
		    		        f.setVisible(true);
	    	            }
	    	            else
	    	            {
		                    JOptionPane.showMessageDialog(frame, "无记录");
	    	            }
	                }    	 
	                // Iterate through the data in the result set and display it.
	                // Handle any errors that may have occurred.
